...
public enum RDBMS {
    POSTGRESQL("PostgreSQL", org.postgresql.Driver.class.getName(), "SELECT 1", new PostgreSQLDialect()),
    MYSQL("MySQL", com.mysql.cj.jdbc.Driver.class.getName(), "SELECT 1", new MySQLDialect()),
    ...
    SQL_SERVER("MS SQL Server (jtds)", net.sourceforge.jtds.jdbc.Driver.class.getName(), "SELECT 1", new SQLServerDialect());
